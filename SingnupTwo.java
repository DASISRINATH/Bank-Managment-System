...
public class SingnupTwo extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e){
        ...
        String sadharNo = adhar.getText();
        
        try{
                Conn c =new Conn();
                String query = "insert into sinuptwo values('"+formno+"', '"+sreligion+"', '"+scategory+"','"+sincome+"', '"+sEducation+"' '"+soccupation+"', '"+spanNo+"', '"+sadharNo+"', '"+ssineorCitizen+"', '"+sexistingACC+"')";

...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        carddetail.setBounds(100, 280,350, 30);
        add(carddetail);
        ...
        pindetails.setBounds(100, 360,300, 30);
        add(pindetails);
        ...
        c7 = new JCheckBox("Hereby declares that the above entered details are correct to best of my knowledge");
        ...
        submit.setBounds(260, 650, 100, 20 );
        ...
        cancel.setBounds(420, 650, 100, 20 );
